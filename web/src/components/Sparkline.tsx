...
// A spark point is either a bare value (snapshot `spark` arrays; temp may
// be null) or an [at, value] tuple (detail `hist` arrays).
export type SparkPoint = number | null | HistPoint<number | null>;
